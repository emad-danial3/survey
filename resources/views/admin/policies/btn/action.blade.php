<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="{{url('admin/policies/edit',$id)}}">{{trans('datatable.edit')}}</a></li>
        <li><a href="#" onclick="deleteConfirmationRole({{$id}})">{{trans('datatable.delete')}}</a></li>
    </ul>
</div>
    ...
    function deleteConfirmationRole(id) {
        swal({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{url('admin/policies/destroy',$id)}}",
