...
@section('content')
                                ...
                                @foreach($page_question as $key=>$question)
                                    <tr>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1">
                                                            <button type="button" class="btn btn-primary " data-toggle="modal"
                                                                    onclick="goToSetValus({{$question['id']}},{{$user['user']['id']}})"
                                                                    data-target="#exampleModal">Edit
                                                            </button>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <button type="button" class="btn btn-danger"
                                                                    onclick="deleteConfirmation({{$question['id']}},{{$user['user']['id']}})">
                                                                Delete
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary " data-toggle="modal"
                                                    onclick="goToSetAddValus({{$question['id']}})"
                                                    data-target="#exampleAddUserModal">Add User
                                            </button>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 ">
                                                ...
                                                @if($locations->where('id','>', 0)->where('status', '1')->count() != 0)
                                                    <div class="form-group">
                                                        <h4>
                                                            <label for="location_id">{{trans('admin.location_id')}}
                                                                *</label>
                                                        </h4>
                                            ...
                                            <div class="col-md-6 ">
                                                ...
                                                @if($categories->where('id','>', 0)->where('status', '1')->count() != 0)
                                                    <div class="form-group">
                                                        <h4>
                                                            <label for="category_id">{{trans('admin.category_id')}}
                                                                *</label>
                                                        </h4>
                                                    ...
                                                    @if($users->where('id','>', 0)->where('status', 'active')->where('user_type', 'worker')->count() != 0)
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="row" style="display: flex">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <a class="btn btn-info " id="add_uesr"> +
                            ...
                            <div class="col-md-6">
                                ...
                                @if($users->where('id','>', 0)->where('status', 'active')->count() != 0)
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control " id="selected_user_to_update" required
                                                name="users">
                                            <option value="">Chose User</option>
                                            @foreach($users->where('id','>', 0)->where('status', 'active')->where('user_type', 'worker') ->get() as $user)
                                                <option
    ...
    <!-- Modal -->
        <div class="modal fade" id="exampleAddUserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($users->where('id','>', 0)->where('status', 'active')->count() != 0)
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control " id="selected_user_to_add" required
                                                name="users">
                                            <option value="">Chose User</option>
                                            @foreach($users->where('id','>', 0)->where('status', 'active')->where('user_type', 'worker') ->get() as $user)
                                                <option
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary" id="save_add_new_user">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#save_chang_user").click(function () {
                ...
                let selected_user = $("#selected_user_to_update").val();
            ...
            $("#save_add_new_user").click(function () {


                let selected_user = $("#selected_user_to_add").val();
                let formData      = new FormData();
                formData.append('id', edituser);
                formData.append('user_id', selected_user);

                let path = base_url + "/admin/saveAddNewUser";
                if (edituser > 0) {
                    $.ajax({
                        url: path,
                        type: 'POST',
        ...
        function goToSetValus(id, user_id) {
            $("#selected_user_to_update").val(user_id);
            edituser    = id;
            oldedituser = user_id;
        }
        function goToSetAddValus(id) {
            edituser    = id;
