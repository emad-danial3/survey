<?php $__env->startSection('page_title'); ?>
    <?php echo e(trans('admin.questionEdit')); ?>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(trans('admin.questionEdit')); ?></h3>
            </div>
            <div class="box-body">
                <div class="box">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="category_id" required
                                    ...
                                    <?php $__currentLoopData = $categories->where('id','>', 0)->where('status', '1')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($category->id); ?>" <?php if($category->id ==  $model->category_id): ?> selected <?php endif; ?>>
                            ...
                            <div  id="">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo Form::textarea('question_title', $model->title , ['class' => 'form-control', 'required' => 'required']); ?>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select id="question_type" name="question_type" class="form-control">
                                            <option value="choice" <?php if( $model->type =='choice'): ?> selected <?php endif; ?>>Choice</option>
                                            <option value="article" <?php if( $model->type =='article'): ?> selected <?php endif; ?>>Article</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        <label for="question_required">Question Required ?</label>
                                        <select id="question_required" name="question_required" class="form-control">
                                            <option value="1"  <?php if( $model->required =='1'): ?> selected <?php endif; ?>>Yes</option>
                                            <option value="0" <?php if( $model->required =='0'): ?> selected <?php endif; ?>>No</option>
                                        </select>
                                    </div>

                                    <?php if($model->type =='choice'): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\emad\survey\resources\views/admin/questions/edit.blade.php ENDPATH**/ ?>