        ...
        <div class="box-body">
            ...
            <div class="col-xl-4">
                <a class="btn btn-success btn-md waves-effect waves-light mb-3"
                   href="<?php echo e(url(route('admin.users.create'))); ?>"
                   style="margin-bottom: 20px">
                    <i class="fa fa-plus-circle"></i> <?php echo e(trans('admin.addCreate')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\emad\survey\resources\views/admin/users/index.blade.php ENDPATH**/ ?>