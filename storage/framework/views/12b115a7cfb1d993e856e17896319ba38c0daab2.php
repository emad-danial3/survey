<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="<?php echo e(url('admin/policies/edit',$id)); ?>"><?php echo e(trans('datatable.edit')); ?></a></li>
        <li><a href="#" onclick="deleteConfirmationRole(<?php echo e($id); ?>)"><?php echo e(trans('datatable.delete')); ?></a></li>
    </ul>
</div>
...
<script type="text/javascript">
    function deleteConfirmationRole(id) {
        swal({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('admin/policies/destroy',$id)); ?>",
                    data: {_token: CSRF_TOKEN},
                    dataType: 'JSON',
                    success: function (results) {

                        if (results.success === true) {
                            $('#datatable_policy').DataTable().ajax.reload();
...
<?php /**PATH /home/oso/Desktop/survey/resources/views/admin/policies/btn/action.blade.php ENDPATH**/ ?>