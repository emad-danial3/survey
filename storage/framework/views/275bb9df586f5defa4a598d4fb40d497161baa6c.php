...
<?php $__env->startSection('page_title'); ?>
    <?php echo e(trans('admin.categoryCreate')); ?>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(trans('admin.categoryCreate')); ?></h3>
            </div>
            <div class="box-body">
                <div class="box">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\emad\survey\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>