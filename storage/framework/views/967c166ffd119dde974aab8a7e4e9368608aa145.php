...
<head>
    ...
    <link href='<?php echo e(url('/')); ?>/polices_files/css/bootstrap.css' rel='stylesheet' type='text/css'/>
    <link href='<?php echo e(url('/')); ?>/polices_files/css/default.css' rel='stylesheet' type='text/css'/>
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                <img class="navbar-brand-logo nav_bar_image" src='<?php echo e(url('/')); ?>/polices_files/logo_egypt.png' alt=""/>
            </a>
        </div>
...
<script src='<?php echo e(url('/')); ?>/polices_files/js/jquery.js'></script>
<script src='<?php echo e(url('/')); ?>/polices_files/js/bootstrap.js'></script>
<script src='<?php echo e(url('/')); ?>/polices_files/js/select2.min.js'></script>
<script src='<?php echo e(url('/')); ?>/polices_files/js/default.js'></script>
...
<?php /**PATH /home/oso/Desktop/survey/resources/views/policies//index.blade.php ENDPATH**/ ?>