<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="<?php echo e(url(route('admin.departments.edit', $id))); ?>"><?php echo e(trans('datatable.edit')); ?></a></li>
    ...
    function deleteConfirmationCategories(id) {
        swal({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('admin/department/delete')); ?>/" + id,
...
<?php /**PATH E:\emad\survey\resources\views/admin/departments/btn/action.blade.php ENDPATH**/ ?>