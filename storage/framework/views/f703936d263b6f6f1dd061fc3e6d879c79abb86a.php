<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="<?php echo e(url(route('admin.locations.edit', $id))); ?>"><?php echo e(trans('datatable.edit')); ?></a></li>
    ...
    function deleteConfirmationCategories(id) {
        swal({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('admin/location/delete')); ?>/" + id,
...
<?php /**PATH E:\emad\survey\resources\views/admin/locations/btn/action.blade.php ENDPATH**/ ?>