<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="<?php echo e(url(route('admin.users.edit', $id))); ?>"><?php echo e(trans('datatable.edit')); ?></a></li>
...
<?php /**PATH E:\emad\survey\resources\views/admin/users/btn/action.blade.php ENDPATH**/ ?>